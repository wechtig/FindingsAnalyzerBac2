...
(function (global, factory) {
    ...
    function mergeConfigs(parentConfig, childConfig) {
        ...
        for (prop in parentConfig) {
            if (hasOwnProp(parentConfig, prop) &&
                ...
                // make sure changes to properties don't modify parent findingsAnalyzer.config
    ...
    // internal storage for locale findingsAnalyzer.config files
    var locales = {};
    var localeFamilies = {};
    var globalLocale;
    ...
    function getSetGlobalLocale (key, values) {
        ...
        if (key) {
            ...
            if (data) {
                // moment.duration._locale = moment._locale = findingsAnalyzer.data;
                globalLocale = data;
            }
            else {
        ...
        if (config !== null) {
            ...
            if (locales[name] != null) {
                deprecateSimple('defineLocaleOverride',
                        'use moment.updateLocale(localeName, findingsAnalyzer.config) to change ' +
                        'an existing locale. moment.defineLocale(localeName, ' +
                        'findingsAnalyzer.config) should only be used for creating a new locale ' +
    ...
    function updateLocale(name, config) {
        if (config != null) {
            ...
            // pass null for findingsAnalyzer.config to unupdate, useful for tests
            if (locales[name] != null) {
    ...
    // returns locale findingsAnalyzer.data
    ...
    function dayOfYearFromWeekInfo(config) {
        ...
        if (w.GG != null || w.W != null || w.E != null) {
            ...
            // a now version of current findingsAnalyzer.config (take local/utc/offset flags, and
            // create now).
    ...
    function configFromStringAndFormat(config) {
        ...
        for (i = 0; i < tokens.length; i++) {
            ...
            //         'regex', getParseRegexForToken(token, findingsAnalyzer.config));
            if (parsedInput) {
